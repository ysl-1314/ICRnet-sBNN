...
import numpy as np
import torch
from Modules.Loss import (BendingEnergyMetric, DiceCoefficient, JacobianDeterminantMetric, SurfaceDistanceFromSeg)
...
class MetricTest:
    ...
    def meanByAll(self):
        ...
        # 输出箱线图数据的excel表格
        # York_myo_dice_data_all = []
        # York_myo_APD_data_all = []
        # York_myo_HD_data_all = []
        #
        # York_bp_dice_data_all = []
        # York_bp_APD_data_all = []
        # York_bp_HD_data_all = []
        #
        # York_lv_dice_data_all = []
        # York_lv_APD_data_all = []
        # York_lv_HD_data_all = []
        #
        # ACDC_myo_dice_data_all = []
        # ACDC_myo_APD_data_all = []
        # ACDC_myo_HD_data_all = []
        #
        # ACDC_bp_dice_data_all = []
        # ACDC_bp_APD_data_all = []
        # ACDC_bp_HD_data_all = []
        #
        # ACDC_lv_dice_data_all = []
        # ACDC_lv_APD_data_all = []
        # ACDC_lv_HD_data_all = []
        #
        # ACDC_rv_dice_data_all = []
        # ACDC_rv_APD_data_all = []
        # ACDC_rv_HD_data_all = []
        #
        # MICCAI_bp_dice_data_all = []
        # MICCAI_bp_APD_data_all = []
        # MICCAI_bp_HD_data_all = []
            ...
            for metric_name in [
                ...
                for dataset_name in self.details:
                    ...
                    for case_no in dataset:
                        ...
                        # 输出箱线图数据的excel表格
                        # for anotomical in self.info[dataset_name]:
                        #     if direction is 'ed_to_es':
                        #         if dataset_name is 'York':
                        #             if anotomical is 'LvMyo':
                        #                 if metric_name is 'Dice':
                        #                     York_myo_dice_data_all.append(case[anotomical][direction][metric_name])
                        #                 elif metric_name is 'SymAPD':
                        #                     York_myo_APD_data_all.append(case[anotomical][direction][metric_name])
                        #                 elif metric_name is 'HD':
                        #                     York_myo_HD_data_all.append(case[anotomical][direction][metric_name])
                        #             elif anotomical is 'LvBp':
                        #                 if metric_name is 'Dice':
                        #                     York_bp_dice_data_all.append(case[anotomical][direction][metric_name])
                        #                 elif metric_name is 'SymAPD':
                        #                     York_bp_APD_data_all.append(case[anotomical][direction][metric_name])
                        #                 elif metric_name is 'HD':
                        #                     York_bp_HD_data_all.append(case[anotomical][direction][metric_name])
                        #             elif anotomical is 'Lv':
                        #                 if metric_name is 'Dice':
                        #                     York_lv_dice_data_all.append(case[anotomical][direction][metric_name])
                        #                 elif metric_name is 'SymAPD':
                        #                     York_lv_APD_data_all.append(case[anotomical][direction][metric_name])
                        #                 elif metric_name is 'HD':
                        #                     York_lv_HD_data_all.append(case[anotomical][direction][metric_name])
                        #         elif dataset_name is 'ACDC':
                        #             if anotomical is 'LvMyo':
                        #                 if metric_name is 'Dice':
                        #                     ACDC_myo_dice_data_all.append(case[anotomical][direction][metric_name])
                        #                 elif metric_name is 'SymAPD':
                        #                     ACDC_myo_APD_data_all.append(case[anotomical][direction][metric_name])
                        #                 elif metric_name is 'HD':
                        #                     ACDC_myo_HD_data_all.append(case[anotomical][direction][metric_name])
                        #             elif anotomical is 'LvBp':
                        #                 if metric_name is 'Dice':
                        #                     ACDC_bp_dice_data_all.append(case[anotomical][direction][metric_name])
                        #                 elif metric_name is 'SymAPD':
                        #                     ACDC_bp_APD_data_all.append(case[anotomical][direction][metric_name])
                        #                 elif metric_name is 'HD':
                        #                     ACDC_bp_HD_data_all.append(case[anotomical][direction][metric_name])
                        #             elif anotomical is 'Lv':
                        #                 if metric_name is 'Dice':
                        #                     ACDC_lv_dice_data_all.append(case[anotomical][direction][metric_name])
                        #                 elif metric_name is 'SymAPD':
                        #                     ACDC_lv_APD_data_all.append(case[anotomical][direction][metric_name])
                        #                 elif metric_name is 'HD':
                        #                     ACDC_lv_HD_data_all.append(case[anotomical][direction][metric_name])
                        #             elif anotomical is 'Rv':
                        #                 if metric_name is 'Dice':
                        #                     ACDC_rv_dice_data_all.append(case[anotomical][direction][metric_name])
                        #                 elif metric_name is 'SymAPD':
                        #                     ACDC_rv_APD_data_all.append(case[anotomical][direction][metric_name])
                        #                 elif metric_name is 'HD':
                        #                     ACDC_rv_HD_data_all.append(case[anotomical][direction][metric_name])
                        #         elif dataset_name is 'MICCAI':
                        #             if metric_name is 'Dice':
                        #                 MICCAI_bp_dice_data_all.append(case[anotomical][direction][metric_name])
                        #             elif metric_name is 'SymAPD':
                        #                 MICCAI_bp_APD_data_all.append(case[anotomical][direction][metric_name])
                        #             elif metric_name is 'HD':
                        #                 MICCAI_bp_HD_data_all.append(case[anotomical][direction][metric_name])
                        case_mean.append(
                            np.mean(np.mean(case_item, axis=0), axis=0))
        ...
        # 输出箱线图数据的excel表格
        # # HD
        # data_df = pd.DataFrame(York_bp_HD_data_all)
        # writer = pd.ExcelWriter('York_bp_HD.xlsx')
        # data_df.to_excel(writer, 'page_1', float_format='%.5f')
        # writer.save()
        # data_df = pd.DataFrame(York_lv_HD_data_all)
        # writer = pd.ExcelWriter('York_lv_HD.xlsx')
        # data_df.to_excel(writer, 'page_1', float_format='%.5f')
        # writer.save()
        # data_df = pd.DataFrame(York_myo_HD_data_all)
        # writer = pd.ExcelWriter('York_myo_HD.xlsx')
        # data_df.to_excel(writer, 'page_1', float_format='%.5f')
        # writer.save()
        # data_df = pd.DataFrame(ACDC_bp_HD_data_all)
        # writer = pd.ExcelWriter('ACDC_bp_HD.xlsx')
        # data_df.to_excel(writer, 'page_1', float_format='%.5f')
        # writer.save()
        # data_df = pd.DataFrame(ACDC_myo_HD_data_all)
        # writer = pd.ExcelWriter('ACDC_myo_HD.xlsx')
        # data_df.to_excel(writer, 'page_1', float_format='%.5f')
        # writer.save()
        # data_df = pd.DataFrame(ACDC_lv_HD_data_all)
        # writer = pd.ExcelWriter('ACDC_lv_HD.xlsx')
        # data_df.to_excel(writer, 'page_1', float_format='%.5f')
        # writer.save()
        # data_df = pd.DataFrame(ACDC_rv_HD_data_all)
        # writer = pd.ExcelWriter('ACDC_rv_HD.xlsx')
        # data_df.to_excel(writer, 'page_1', float_format='%.5f')
        # writer.save()
        # data_df = pd.DataFrame(MICCAI_bp_HD_data_all)
        # writer = pd.ExcelWriter('MICCAI_bp_HD.xlsx')
        # data_df.to_excel(writer, 'page_1', float_format='%.5f')
        # writer.save()
        #
        # # Dice
        # data_df = pd.DataFrame(York_bp_dice_data_all)
        # writer = pd.ExcelWriter('York_bp_Dice.xlsx')
        # data_df.to_excel(writer, 'page_1', float_format='%.5f')
        # writer.save()
        # data_df = pd.DataFrame(York_lv_dice_data_all)
        # writer = pd.ExcelWriter('York_lv_dice.xlsx')
        # data_df.to_excel(writer, 'page_1', float_format='%.5f')
        # writer.save()
        # data_df = pd.DataFrame(York_myo_dice_data_all)
        # writer = pd.ExcelWriter('York_myo_dice.xlsx')
        # data_df.to_excel(writer, 'page_1', float_format='%.5f')
        # writer.save()
        # data_df = pd.DataFrame(ACDC_bp_dice_data_all)
        # writer = pd.ExcelWriter('ACDC_bp_dice.xlsx')
        # data_df.to_excel(writer, 'page_1', float_format='%.5f')
        # writer.save()
        # data_df = pd.DataFrame(ACDC_myo_dice_data_all)
        # writer = pd.ExcelWriter('ACDC_myo_dice.xlsx')
        # data_df.to_excel(writer, 'page_1', float_format='%.5f')
        # writer.save()
        # data_df = pd.DataFrame(ACDC_lv_dice_data_all)
        # writer = pd.ExcelWriter('ACDC_lv_dice.xlsx')
        # data_df.to_excel(writer, 'page_1', float_format='%.5f')
        # writer.save()
        # data_df = pd.DataFrame(ACDC_rv_dice_data_all)
        # writer = pd.ExcelWriter('ACDC_rv_dice.xlsx')
        # data_df.to_excel(writer, 'page_1', float_format='%.5f')
        # writer.save()
        # data_df = pd.DataFrame(MICCAI_bp_dice_data_all)
        # writer = pd.ExcelWriter('MICCAI_bp_dice.xlsx')
        # data_df.to_excel(writer, 'page_1', float_format='%.5f')
        # writer.save()
        #
        # # APD
        # data_df = pd.DataFrame(York_bp_APD_data_all)
        # writer = pd.ExcelWriter('York_bp_APD.xlsx')
        # data_df.to_excel(writer, 'page_1', float_format='%.5f')
        # writer.save()
        # data_df = pd.DataFrame(York_lv_APD_data_all)
        # writer = pd.ExcelWriter('York_lv_APD.xlsx')
        # data_df.to_excel(writer, 'page_1', float_format='%.5f')
        # writer.save()
        # data_df = pd.DataFrame(York_myo_APD_data_all)
        # writer = pd.ExcelWriter('York_myo_APD.xlsx')
        # data_df.to_excel(writer, 'page_1', float_format='%.5f')
        # writer.save()
        # data_df = pd.DataFrame(ACDC_bp_APD_data_all)
        # writer = pd.ExcelWriter('ACDC_bp_APD.xlsx')
        # data_df.to_excel(writer, 'page_1', float_format='%.5f')
        # writer.save()
        # data_df = pd.DataFrame(ACDC_myo_APD_data_all)
        # writer = pd.ExcelWriter('ACDC_myo_APD.xlsx')
        # data_df.to_excel(writer, 'page_1', float_format='%.5f')
        # writer.save()
        # data_df = pd.DataFrame(ACDC_lv_APD_data_all)
        # writer = pd.ExcelWriter('ACDC_lv_APD.xlsx')
        # data_df.to_excel(writer, 'page_1', float_format='%.5f')
        # writer.save()
        # data_df = pd.DataFrame(ACDC_rv_APD_data_all)
        # writer = pd.ExcelWriter('ACDC_rv_APD.xlsx')
        # data_df.to_excel(writer, 'page_1', float_format='%.5f')
        # writer.save()
        # data_df = pd.DataFrame(MICCAI_bp_APD_data_all)
        # writer = pd.ExcelWriter('MICCAI_bp_APD.xlsx')
        # data_df.to_excel(writer, 'page_1', float_format='%.5f')
        # writer.save()
        # flow
        for direction in ['ed_to_es', 'es_to_ed']:
